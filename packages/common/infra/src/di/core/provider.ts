...
export abstract class ServiceProvider {
  ...
  get<T>(identifier: GeneralServiceIdentifier<T>, options?: ResolveOptions): T {
    return this.getRaw(parseIdentifier(identifier), options);
  }
  ...
  getAll<T>(
    ...
    return this.getAllRaw(parseIdentifier(identifier), options);
  }
}
...
export class BasicServiceProvider extends ServiceProvider {
  ...
  constructor(
    ...
    this.collection.addValue(ServiceProvider, this, { scope: scope });
  }
